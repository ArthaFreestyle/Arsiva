...
seed : 
	migrate -database "postgres://artha:passwordku@localhost:5432/arsiva?sslmode=disable" -path /home/artha/Documents/Arsiva/db/migrations_seed up

seed-down : 
	migrate -database "postgres://artha:passwordku@localhost:5432/arsiva?sslmode=disable" -path /home/artha/Documents/Arsiva/db/migrations_seed down
